...
if(isset($_GET['q']))
{
  $_SESSION['text']=$_GET['q'];
  $text=$_SESSION['text'];
  echo '<script type="text/javascript"> pagernumber(); </script>';
...
<head>
    <script type="text/javascript">
          ...
          function pagernumber(){
            ...
            var text1='<?php echo $_SESSION["text"]; ?>';
            if(text1.search('classic')!=-1){
              location.href = 'classic-tours.php';
              ;
            }
            if(text1.search('1')!=-1){
              location.href = '1-day-tours.php';
              ;
            }
            if(text1.search('3')!=-1){
              location.href = '3_Day_tour.php';
              ;
            }
            if(text1.search('4')!=-1){
              location.href = '4-day-tours.php';
              ;
            }
            if(text1.search('7')!=-1){
              location.href = '7-day-tours.php';
              ;
            }
            if(text1.search('10')!=-1){
              location.href = '10_Day_Tour.php';
              ;
            }
            if(text1.search('contact')!=-1){
              location.href = 'contact.php';
              ;
            }
            if(text1.search('hiking')!=-1){
              location.href = 'hiking-tours.php';
              ;
            }
            if(text1.search('login')!=-1){
              location.href = 'login.php';
              ;
            }
            if(text1.search('all')!=-1){
              location.href = 'tour-list.php';
              ;
            }
          }
